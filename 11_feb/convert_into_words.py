        ...
        if n>99999:   
            ...
            if d[4]!=0:                      # ex : 3456 d =[6,5,4,3]
                if(d[4]==1):                 #  # Last element of list
                    ...
                    num+=nty[d[4]]+" "+Ones[d[3]]+  " Thousand "    #combining the last and third words of list 
            else:
                if d[3]!=0:
                    num+=Ones[d[3]]+ " Thousand " # if last element is zero
            if d[2]!=0:
...
div = convert_to_words(format_input_amount)
print(div(amount))